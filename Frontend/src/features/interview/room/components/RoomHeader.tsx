    ...
    <div className="flex items-center justify-between border-b border-gray-800 pb-4">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg border border-[#00E599]/30 bg-[#00E599]/5 text-xs font-bold text-[#00E599]">
          ...
          <span className="font-mono tracking-wider">{mockTime}</span>
        </div>

        {/* End Interview Button */}
        <button className="px-4 py-1.5 rounded-md border border-rose-500/40 hover:border-rose-500/80 bg-rose-500/5 hover:bg-rose-500/10 text-[10px] font-black tracking-widest text-rose-400 hover:text-rose-300 uppercase transition-all">
          End Interview
        </button>
      </div>
    </div>
