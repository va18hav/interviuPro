...
export default function Step3Success({ firstName }: { firstName: string }) {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto flex flex-col items-center pt-8">
      ...
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-white mb-4 tracking-tight">You're all set, {firstName}</h1>
      ...
      <button
        ...
        className="w-full max-w-sm bg-[#00E599] hover:bg-[#00c985] text-black font-semibold py-3.5 rounded-md text-sm transition-colors flex items-center justify-center gap-2 mb-8">
